...
public class Constants {
    ...
    // Log
    public final static String TAG_MAIN_ACTIVITY = "wen-MainActivity";
    public final static String TAG_SHARE_BOOK_CLIENT = "wen-ShareBookClient";
    public final static String TAG_GET_BOOK_DATA_TASK = "wen-GetBookIdTask";
    public final static String TAG_API_HELPER = "wen-ApiHelper";
